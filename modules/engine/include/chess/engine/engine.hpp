...
namespace chess { namespace engine {
    ...
    extern inline bool has_white_pawn(const Game* game, U8 index);
    extern inline bool has_white_knight(const Game* game, U8 index);
    extern inline bool has_white_bishop(const Game* game, U8 index);
    extern inline bool has_white_rook(const Game* game, U8 index);
    extern inline bool has_white_queen(const Game* game, U8 index);
    extern inline bool has_white_king(const Game* game, U8 index);
    extern inline bool has_black_pawn(const Game* game, U8 index);
    extern inline bool has_black_knight(const Game* game, U8 index);
    extern inline bool has_black_bishop(const Game* game, U8 index);
    extern inline bool has_black_rook(const Game* game, U8 index);
    extern inline bool has_black_queen(const Game* game, U8 index);
    extern inline bool has_black_king(const Game* game, U8 index);
    extern inline bool has_white_piece(const Game* game, U8 index);
    extern inline bool has_black_piece(const Game* game, U8 index);
    extern bool is_empty(const Game* game, U8 index);
    extern Piece get_piece(const Game* game, U8 index);
